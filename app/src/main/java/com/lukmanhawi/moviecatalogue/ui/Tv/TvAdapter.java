...
import com.lukmanhawi.moviecatalogue.detail.DetailTvActivity;
...
public class TvAdapter extends RecyclerView.Adapter<TvAdapter.TvViewHolder> {
    ...
    static class TvViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(TvEntity tv) {
            binding.tvItemTitle.setText(tv.gettTitle());
            binding.tvItemDate.setText(tv.gettDate());
